...
<div class="container" style="margin-top: -0px; padding-right: 0px; padding-top: 20px;" >
		<div class="content" style="margin-left: 0px; "  >
			...
			<div class="page-header">
				...
				<form:form method="post" action="deactivateUsers" commandName="enabledUsersToDeactivateModel">
					<fieldset>
...
<!-- 									</div>				 -->
<!-- 								</div> -->
									<input type="submit" class="btn primary" style="float: right;" value="Disable">
							</div>
						</div>
					</fieldset>
				</form:form>				
